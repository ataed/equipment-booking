...
// We check for "window" because Next.js renders on the server where there is no browser.
// Firebase Messaging only works in the browser, so we only initialize it there.
